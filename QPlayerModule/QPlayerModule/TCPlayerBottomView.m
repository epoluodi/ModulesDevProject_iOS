...
#define TC_VIDEO_TYPE_BTN_RIGHT_MARGIN (12)
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        [_playPauseButton setBackgroundImage:[UIImage imageNamed:@"res_moduleDemo/pause"] forState:UIControlStateNormal];
...
#pragma clang diagnostic pop
        ...
        _movieTimeControl.maximumTrackTintColor = [[UIColor grayColor] colorWithAlphaComponent:0.4];
        ...
        [_fullScreenButton setImage:[UIImage imageNamed:@"res_moduleDemo/full"] forState:UIControlStateNormal];
...
- (void)layoutSubviews
{
    ...
    _fullScreenButton.frame = CGRectMake(bounds.size.width - 22 - TC_VIDEO_TYPE_BTN_RIGHT_MARGIN, (bounds.size.height - 22)/2, 22, 22);
...
- (void)updateOnFullScreenChangeTo:(BOOL)full
{
    ...
    _fullScreenButton.selected = isFull;
    if (isFull)
        [_fullScreenButton setImage:[UIImage imageNamed:@"res_moduleDemo/exitfull"] forState:UIControlStateNormal];
    else
        [_fullScreenButton setImage:[UIImage imageNamed:@"res_moduleDemo/full"] forState:UIControlStateNormal];
}
